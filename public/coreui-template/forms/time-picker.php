...
$pageTitle = 'Time Picker - ' . $config['siteName'];
$pageDescription = 'Time picker form control component';
$currentPage = 'time-picker';
        ...
        <div class="container-lg px-4">
          <div class="bg-primary bg-opacity-10 border border-2 border-primary rounded mb-4">
            <div class="row d-flex align-items-center p-3 px-xl-4 flex-xl-nowrap">
              ...
              <div class="col-md-auto col-12 mt-3 mt-lg-0"><a class="btn btn-primary text-nowrap text-white" href="https://coreui.io/bootstrap/docs/forms/time-picker/" target="_blank" rel="noopener noreferrer">Explore Documentation</a></div>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/time-picker/#example" target="_blank">
                          <svg class="icon me-2">
                    ...
                    <div class="tab-content rounded-bottom">
                      <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                        <div class="row">
                          ...
                          <div class="col-lg-3">
                            <div data-coreui-value="02:17:35 PM" data-coreui-locale="en-US" data-coreui-toggle="time-picker"></div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-12">
              <div class="card mb-4">
                <div class="card-header"><strong>Time Picker</strong><span class="small ms-1">Sizing</span></div>
                <div class="card-body">
                  ...
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/time-picker/#sizing" target="_blank">
                          <svg class="icon me-2">
                            <use xlink:href="<?= $baseDir ?>vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                          </svg>Code</a></li>
                    </ul>
            ...
            <div class="col-12">
              <div class="card mb-4">
                <div class="card-header"><strong>Time Picker</strong><span class="small ms-1">Disabled</span></div>
                <div class="card-body">
                  ...
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/time-picker/#disabled" target="_blank">
                          <svg class="icon me-2">
                            <use xlink:href="<?= $baseDir ?>vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                          </svg>Code</a></li>
                    </ul>
            ...
            <div class="col-12">
              <div class="card mb-4">
                <div class="card-header"><strong>Time Picker</strong><span class="small ms-1">Readonly</span></div>
                <div class="card-body">
                  ...
                  <div class="example">
                    <ul class="nav nav-underline-border" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" href="https://coreui.io/bootstrap/docs/forms/time-picker/#readonly" target="_blank">
                          <svg class="icon me-2">
                            <use xlink:href="<?= $baseDir ?>vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                          </svg>Code</a></li>
                    </ul>
                    <div class="tab-content rounded-bottom">
                      <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1003">
                        <div class="row">
                          <div class="col-lg-4">
                            <div data-coreui-input-read-only="true" data-coreui-locale="en-US" data-coreui-toggle="time-picker"></div>
                          </div>
                        </div>
                      </div>
                    </div>
