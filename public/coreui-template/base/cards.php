...
$pageTitle = 'Cards - ' . $config['siteName'];
$pageDescription = 'Cards component examples with various styles and configurations for building flexible and customizable content containers.';
$currentPage = 'cards';
$currentSection = 'base';
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                    <div class="card" style="width: 18rem;"><img class="card-img-top" src="<?= $baseDir ?>assets/img/full.jpg" alt="">
                      <div class="card-body">
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1016">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="card mb-3"><img class="card-img-top" src="<?= $baseDir ?>assets/img/full.jpg" alt="">
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                      ...
                      <div class="col-md-6">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text"><small class="text-body-secondary">Last updated 3 mins ago</small></p>
                          </div><img class="card-img-bottom" src="<?= $baseDir ?>assets/img/full.jpg" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1017">
                    <div class="card bg-dark text-white"><img class="card-img" src="<?= $baseDir ?>assets/img/full.jpg" alt="">
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1018">
                    <div class="card">
                      <div class="row g-0">
                        <div class="col-md-4"><img class="card-img" src="<?= $baseDir ?>assets/img/full.jpg" alt=""></div>
                        <div class="col-md-8">
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1023">
                    <div class="card-group">
                      <div class="card"><img class="card-img-top" src="<?= $baseDir ?>assets/img/full.jpg" alt="">
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                          <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                          <p class="card-text"><small class="text-body-secondary">Last updated 3 mins ago</small></p>
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1027">
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                      <div class="col">
                        <div class="card h-100"><img class="card-img-top" src="<?= $baseDir ?>assets/img/full.jpg" alt="">
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                          </div>
