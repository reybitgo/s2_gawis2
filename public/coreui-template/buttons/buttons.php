...
$pageTitle = 'Buttons - ' . $config['siteName'];
$pageDescription = 'Bootstrap button components and styles';
$currentPage = 'buttons';
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-auto">
                        <button class="btn btn-primary" type="button">
                          <svg class="icon me-2">
                            <use xlink:href="<?= $baseDir ?>vendors/@coreui/icons/svg/free.svg#cil-contrast"></use>
                          </svg>Primary
                        </button>
