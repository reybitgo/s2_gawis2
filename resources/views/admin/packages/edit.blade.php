                ...
                <div class="card-header">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            ...
                            <strong>Edit Package: {{ $package->name }}</strong>
                            <small class="text-body-secondary ms-2 d-none d-md-inline">
                                Modify package settings and information
                            </small>
                        </div>
                        <div class="d-flex gap-2 flex-wrap">
                            @if($package->is_mlm_package)
                                <a href="{{ route('admin.packages.mlm.edit', $package) }}" class="btn btn-warning">
                                    <svg class="icon me-2">
                            ...
                            @endif
                            <a href="{{ route('admin.packages.show', $package) }}" class="btn btn-info">
                                <svg class="icon me-2">
